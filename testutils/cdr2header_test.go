...
import (
	...
	"vendor/github.com/fulldump/apitest"
	"vendor/github.com/fulldump/golax"
)

func Test_Cdr2Header(t *testing.T) {
	...
	a.Root.
		...
		c.LastError = &golax.ContextError{
			StatusCode:  222,
			ErrorCode:   222333,
	...
	if 222333 != cdr.Response.Error.Code {
